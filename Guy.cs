...
namespace BettingGame
{
    class Guy
    {
        ...
        {
            Console.WriteLine("My Name is " + Name + " and I have " + Cash + " bucks on my balance sheet.");
        }

        /// <summary>
        /// Give some of my cash, removing it from my wallet (or printing 
        /// a message to the console if I don't have enough cash).
        /// </summary>
        /// <param name="amount">Amount of cash to gibe.</param>
        /// <returns>
        /// The amount of cash removed from my wallet, or 0 if I don't
        /// have enought cash (or if the amount is invalid).</returns>
